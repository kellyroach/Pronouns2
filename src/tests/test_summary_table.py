...
def run_test_summary_table(file: str, **kwargs) -> None:
    """Shared subroutine for testing demo_write_summary_table.
...
class TestSummaryTable(TestCase):
    def test_summary_table_txt(self):
        """Test doc with file_type=FileType.TXT."""
        run_test_summary_table(file="test_summary_table.txt", file_type=FileType.TXT)
    def test_summary_table_tex(self):
        """Test doc with file_type=FileType.TEX."""
        run_test_summary_table(file="test_summary_table.tex", file_type=FileType.TEX)
